...
function App() {
  ...
  const [diaryTitle, setDiaryTitle] = useState(() => localStorage.getItem('기분좋은 토요일') || '기본좋은 토요일');
...
//  *************************************************************************************   
    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="mainHeader">
          <div className='mainTitle'><Avatar alt="AI" sx={{ width: 45, height: 45 }} src="http://file3.instiz.net/data/cached_img/upload/2021/03/22/13/ed669ef118cbf02ab425d876ea627eae.jpg" />&nbsp;&nbsp;&nbsp; {editingTitle ? (
            <input
              type="text"
              value={tempTitle}
  ...
  {/* //  ************************************************************************************* */}
    ...
    <div className='temp2'></div>
      ...
      <div>
      <Card sx={{ maxWidth: 300, mx: 'auto', display: 'block', mb: 2  }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="140"
    ...
    <Card sx={{ maxWidth: 300, mx: 'auto', display: 'block', mb: 2 }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="140"
          image="https://www.hanbit.co.kr/data/editor/20200219134956_vphynybz.jpg"
          alt="green iguana"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" component="div">
          ...
          <Typography variant="body2" color="text.secondary">
            제목을 쓰는건  한줄로 글을 써서 여기는 한줄 글이 될 것이다.
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
    ...
    <Card sx={{ maxWidth: 300, mx: 'auto', display: 'block', mb: 2 }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="140"
          image="https://visla.kr/wp/wp-content/uploads/2018/03/20180329_01.jpg"
          alt="green iguana"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" component="div">
          ...
          <Typography variant="body2" color="text.secondary">
            지하철을 탓는데 오늘 너무 힘이들었따. 앞으로도 계속해서 지하철을 타야할텐데 막막하다...
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
    ...
    <Card sx={{ maxWidth: 300, mx: 'auto', display: 'block', mb: 2 }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="140"
          image="https://image.fnnews.com/resource/media/image/2023/03/27/202303271136462004_l.jpg"
          alt="green iguana"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" component="div">
